...
const newToken = (tokenType, value = null) => {
    ...
    tokens.push(token);
    // console.log(`Generated Token: ${tokenType}`, token);
    // const tokenList = tokens.forEach(token => console.log(`Type: ${token.type}, Value: `, token.value));

    // console.log('Tokens: ', tokenList); // output => [Token, Token, ..]
